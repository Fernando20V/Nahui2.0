...
class PlaceFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        // IDs válidos de departamentos y municipios
        $departmentId = Department::inRandomOrder()->value('id') ?? Department::factory()->create()->id;
        $municipalityId = Municipality::where('department_id', $departmentId)->inRandomOrder()->value('id')
            ?? Municipality::factory()->create(['department_id' => $departmentId])->id;
